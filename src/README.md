...
"Selected Topics" (not in the above list): if we get everything else done by, say, Nov 1, I'd say let's try to run up the score by doing a handful of these. Sorting Networks, String-Matching, NP-Completeness, etc. all lend themselves to some amount of diagramming.
